  ...
  <tbody class="table-hover">
    ...
    if (is_array($cinemaList) || is_object($cinemaList))
    {
      foreach ($cinemaList as $cinema) {
        ...
        if($cinema->getdeleteCinema()==false){
          ?>
          <tr>
           ...
           <th>
            <nav class="navbar navbar-expand-lg">
              ...
              <li class="nav-item">
                <form method="POST">
                 <div class="p-2">
                  <button formaction="<?php echo FRONT_ROOT ?>Room/List" class="btn btn-secondary" type="submit" name="modifyId" value="<?php echo $cinema->getidCinema(); ?>">Rooms</button>        
                </div>
              </li>
               <li class="nav-item">
                <form method="POST">
