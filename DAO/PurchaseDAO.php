...
class PurchaseDAO
{
    public static function addPurchase(int $numberOfTickets, int $functionId, int $creditCardId, int $idDiscount)
    {
        try {
            ...
            $params['creditCardId'] = CreditCardDAO::getCreditCardIdFromNumber($creditCardId);
